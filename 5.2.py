...
# если что заметки это чтобы про это задачу не забывать очень интересная, чтобы если что можно было понять как она решается, вот только не говорите что можно было решить легче(
